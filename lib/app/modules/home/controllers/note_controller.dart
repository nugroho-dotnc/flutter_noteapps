...
class NoteController extends GetxController {
  ...
  void onInit() {
    super.onInit();
    //on app startup we can read an existing note
    readNotes();
  }
          ...
          AlertDialog(
            ...
            actions: [
              MaterialButton(onPressed: () {
                context.read<NoteDatabase>().create(textController.text);
  ...
  //read note
  void readNotes() {
    Get.context!.read<NoteDatabase>().fetchNote();
  }
    ...
    showDialog(context: Get.context!, builder: (context) {
      return AlertDialog(
        ...
        title: Center(child: Text("ALERT !", style: GoogleFonts.dmSerifText(
            ...
            .colorScheme
            .inversePrimary),)),
        content: Text("Notes yang dihapus tidak dapat di restore, anda yakin?",
